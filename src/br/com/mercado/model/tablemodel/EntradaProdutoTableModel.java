 ...
 * @author William
 */
public class EntradaProdutoTableModel extends AbstractTableModel implements AcoesTableModel<Produto> {
    ...
    public EntradaProdutoTableModel(List<Produto> listProdutos) {
